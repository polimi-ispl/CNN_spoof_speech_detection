...
# NOTE: THIS CONFIGURATION NEEDS TO BE TRAINED AGAIN

batch_size = 5

results_path = '/nas/home/cborrelli/cnn_bot/results/myvggish'
...
if __name__=='__main__':
    ...
    # Plot histories
    history_root = "/nas/home/cborrelli/cnn_bot/history/myvggish"
    history_filename = '/nas/home/cborrelli/cnn_bot/history/myvggish/model_classification_{}_classes_{}.npy'.format(
    ...
    model_path = '/nas/home/cborrelli/cnn_bot/checkpoints/myvggish/model_classification_{}_classes_{}'.format(
    classification_type, '_'.join(classes_list))
    ...
    results.to_pickle(os.path.join(results_path, 'results_classification_{}_classes_{}.pkl'.format(classification_type,
                                                                                               '_'.join(classes_list)) ))
