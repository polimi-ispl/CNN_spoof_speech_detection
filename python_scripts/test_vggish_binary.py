...
if __name__=='__main__':
    ...
    # Plot histories
    # history_root = "/nas/home/cborrelli/cnn_bot/history/vggish"
    # history_filename = '/nas/home/cborrelli/cnn_bot/history/vggish/model_classification_{}_classes_{}.npy'.format(
    ...
    results.to_pickle(os.path.join(results_path, 'results_classification_{}_classes_{}.pkl'.format('binary',
