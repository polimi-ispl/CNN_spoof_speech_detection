...
if __name__=='__main__':
    ...
    checkpoint_path = '/nas/home/cborrelli/cnn_bot/checkpoints/myvggish/model_classification_{}_classes_{}_balanced_{}'.format(
        classification_type, '_'.join(classes_list), balance_dataset)
    my_callbacks = [
    ...
    history_name = '/nas/home/cborrelli/cnn_bot/history/vggish/model_classification_{}_classes_{}_balanced_{}.npy'.format(
        classification_type, '_'.join(classes_list), balance_dataset)
    # Save history
